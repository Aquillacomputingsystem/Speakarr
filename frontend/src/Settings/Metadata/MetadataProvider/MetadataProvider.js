            ...
            <FieldSet legend={translate('CalibreMetadata')}>
              <FormGroup>
                ...
                <FormInputGroup
                  ...
                  helpLink="https://wiki.servarr.com/speakarr/settings#write-metadata-to-book-files"
            ...
            <FieldSet legend={translate('AudioFileMetadata')}>
              <FormGroup>
                ...
                <FormInputGroup
                  ...
                  name="writeAudioTags"
                  helpTextWarning={translate('WriteBookTagsHelpTextWarning')}
                  helpLink="https://wiki.servarr.com/speakarr/settings#write-metadata-to-audio-files"
