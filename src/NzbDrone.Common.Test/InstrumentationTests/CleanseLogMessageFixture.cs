...
namespace NzbDrone.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        [TestCase(@"https://rss.omgwtfnzbs.org/rss-search.php?catid=19,20&user=Speakarr&api=mySecret&eng=1")]
        ...
        [TestCase("/speakarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=speakarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=speakarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        // Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/speakarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
