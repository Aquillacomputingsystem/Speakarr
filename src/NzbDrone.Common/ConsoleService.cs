...
namespace NzbDrone.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Speakarr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Speakarr terminating any other instances", StartupContext.TERMINATE);
