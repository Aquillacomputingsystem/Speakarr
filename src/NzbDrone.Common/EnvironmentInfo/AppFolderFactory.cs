...
namespace NzbDrone.Common.EnvironmentInfo
{
    ...
    public class AppFolderFactory : IAppFolderFactory
    {
        ...
        public void Register()
        {
            ...
            {
                throw new SpeakarrStartupException("Cannot create AppFolder, Access to the path {0} is denied", _appFolderInfo.AppDataFolder);
            }
            ...
            {
                throw new SpeakarrStartupException("AppFolder {0} is not writable", _appFolderInfo.AppDataFolder);
            }
