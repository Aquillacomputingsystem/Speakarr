...
namespace NzbDrone.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "speakarr.db";
        private const string DB_RESTORE = "speakarr.restore";
        private const string LOG_DB = "logs.db";
        private const string CACHE_DB = "cache.db";
        private const string NLOG_CONFIG_FILE = "nlog.config";
        private const string UPDATE_CLIENT_EXE_NAME = "Speakarr.Update";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "speakarr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Speakarr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "speakarr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "speakarr_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Speakarr.Update" + Path.DirectorySeparatorChar;
