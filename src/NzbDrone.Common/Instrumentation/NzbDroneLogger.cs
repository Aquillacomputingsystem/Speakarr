...
namespace NzbDrone.Common.Instrumentation
{
    public static class NzbDroneLogger
    {
        ...
        {
            RegisterAppFile(appFolderInfo, "appFileInfo", "speakarr.txt", 5, LogLevel.Info);
            RegisterAppFile(appFolderInfo, "appFileDebug", "speakarr.debug.txt", 50, LogLevel.Off);
            RegisterAppFile(appFolderInfo, "appFileTrace", "speakarr.trace.txt", 50, LogLevel.Off);
        }
