...
namespace NzbDrone.Console
{
    public static class ConsoleApp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            catch (SpeakarrStartupException ex)
            {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + ". This can happen if another instance of Speakarr is already running another application is using the same port (default: 8788) or the user has insufficient permissions");
