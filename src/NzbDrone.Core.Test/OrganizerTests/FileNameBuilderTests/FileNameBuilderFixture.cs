    ...
    public class FileNameBuilderFixture : CoreTest<FileNameBuilder>
    {
        ...
        public void Setup()
        {
            ...
            _trackFile = Builder<BookFile>.CreateNew()
                ...
                .With(e => e.ReleaseGroup = "SpeakarrTest")
        ...
        [Test]
        public void should_use_Speakarr_as_release_group_when_not_available()
        {
        ...
        [TestCase("{Book Title}{ Release Group}", "Hybrid Theory")]
        [TestCase("{Book Title}{ [Release Group]}", "Hybrid Theory")]
        public void should_not_use_Speakarr_as_release_group_if_pattern_has_separator(string pattern, string expectedFileName)
        {
            _trackFile.ReleaseGroup = null;
