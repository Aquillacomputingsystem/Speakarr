...
namespace NzbDrone.Core.Download.Clients.DownloadStation
{
    ...
    public class DownloadStationSettings : IProviderConfig
    {
        ...
        [FieldDefinition(5, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Speakarr avoids conflicts with unrelated non-Speakarr downloads. Using a category is optional, but strongly recommended. Creates a [category] subdirectory in the output directory.")]
