...
namespace NzbDrone.Core.Download.Clients.Sabnzbd
{
    ...
    public class SabnzbdSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Speakarr avoids conflicts with unrelated non-Speakarr downloads. Using a category is optional, but strongly recommended.")]
