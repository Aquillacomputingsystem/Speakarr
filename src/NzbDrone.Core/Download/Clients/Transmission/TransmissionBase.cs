    ...
    public abstract class TransmissionBase : TorrentClientBase<TransmissionSettings>
    {
        ...
        protected ValidationFailure TestConnection()
        {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                {
                    DetailedDescription = string.Format("Please verify your username and password. Also verify if the host running Speakarr isn't blocked from accessing {0} by WhiteList limitations in the {0} configuration.", Name)
                };
            }
