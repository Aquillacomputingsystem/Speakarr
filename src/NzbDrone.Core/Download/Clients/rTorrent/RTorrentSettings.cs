...
namespace NzbDrone.Core.Download.Clients.RTorrent
{
    ...
    public class RTorrentSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Speakarr avoids conflicts with unrelated non-Speakarr downloads. Using a category is optional, but strongly recommended.")]
        public string MusicCategory { get; set; }

        [FieldDefinition(7, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for Speakarr to set after it has imported the download. Speakarr will not remove torrents in that category even if seeding finished. Leave blank to keep same category.")]
