...
namespace NzbDrone.Core.Download.Clients.UTorrent
{
    ...
    public class UTorrentSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for Speakarr to set after it has imported the download. Speakarr will not remove the torrent if seeding has finished. Leave blank to keep same category.")]
