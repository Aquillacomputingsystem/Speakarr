...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class ProxyCheck : HealthCheckBase
    {
        ...
        public ProxyCheck(ISpeakarrCloudRequestBuilder cloudRequestBuilder, IConfigService configService, IHttpClient client, ILocalizationService localizationService, Logger logger)
