...
namespace NzbDrone.Core.Indexers.Gazelle
{
    ...
    public class GazelleSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(5, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date Speakarr will download from this indexer, empty is no limit", Advanced = true)]
