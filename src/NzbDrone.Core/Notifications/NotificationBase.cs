...
namespace NzbDrone.Core.Notifications
{
        ...
        where TSettings : IProviderConfig, new()
    {
        ...
        protected const string BOOK_GRABBED_TITLE_BRANDED = "Speakarr - " + BOOK_GRABBED_TITLE;
        protected const string BOOK_DOWNLOADED_TITLE_BRANDED = "Speakarr - " + BOOK_DOWNLOADED_TITLE;
        protected const string AUTHOR_ADDED_TITLE_BRANDED = "Speakarr - " + AUTHOR_ADDED_TITLE;
        protected const string AUTHOR_DELETED_TITlE_BRANDED = "Speakarr - " + AUTHOR_DELETED_TITLE;
        protected const string BOOK_DELETED_TITLE_BRANDED = "Speakarr - " + BOOK_DELETED_TITLE;
        protected const string BOOK_FILE_DELETED_TITLE_BRANDED = "Speakarr - " + BOOK_FILE_DELETED_TITLE;
        protected const string HEALTH_ISSUE_TITLE_BRANDED = "Speakarr - " + HEALTH_ISSUE_TITLE;
        protected const string DOWNLOAD_FAILURE_TITLE_BRANDED = "Speakarr - " + DOWNLOAD_FAILURE_TITLE;
        protected const string IMPORT_FAILURE_TITLE_BRANDED = "Speakarr - " + IMPORT_FAILURE_TITLE;
        protected const string BOOK_RETAGGED_TITLE_BRANDED = "Speakarr - " + BOOK_RETAGGED_TITLE;
        protected const string APPLICATION_UPDATE_TITLE_BRANDED = "Speakarr - " + APPLICATION_UPDATE_TITLE;
