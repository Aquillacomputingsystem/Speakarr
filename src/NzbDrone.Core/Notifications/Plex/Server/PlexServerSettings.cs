...
namespace NzbDrone.Core.Notifications.Plex.Server
{
    ...
    public class PlexServerSettings : IProviderConfig
    {
        ...
        [FieldDefinition(6, Label = "Map Paths From", Type = FieldType.Textbox, Advanced = true, HelpText = "Speakarr path, used to modify author paths when Plex sees library path location differently from Speakarr")]
        public string MapFrom { get; set; }

        [FieldDefinition(7, Label = "Map Paths To", Type = FieldType.Textbox, Advanced = true, HelpText = "Plex path, used to modify author paths when Plex sees library path location differently from Speakarr")]
