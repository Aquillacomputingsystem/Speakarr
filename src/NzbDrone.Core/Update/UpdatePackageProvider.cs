...
namespace NzbDrone.Core.Update
{
    ...
    public class UpdatePackageProvider : IUpdatePackageProvider
    {
        ...
        public UpdatePackageProvider(IHttpClient httpClient, ISpeakarrCloudRequestBuilder requestBuilder, IAnalyticsService analyticsService, IPlatformInfo platformInfo, IMainDatabase mainDatabase)
        {
