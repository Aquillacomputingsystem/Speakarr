...
namespace NzbDrone.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/speakarr")
        {
        ...
        public static IRuleBuilderOptions<T, string> ContainsSpeakarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("speakarr", RegexOptions.IgnoreCase)).WithMessage("Must contain speakarr");
        }
    }
}
